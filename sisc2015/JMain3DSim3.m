...
e0=ylength/1.8*4*4.5*10*10^-6*tan(0.13)*co/1;  %/2 is usually /1.5
...
% Edens1=zeros(Em,En+1,Ep+1);
% Edens1(:,1:En,1:Ep)=Edens{1}.Edensin;
% Edens1(:,En+1,1:Ep)=Edens{1}.Edensin(:,1,:);
% Edens1(:,1:En,Ep+1)=Edens{1}.Edensin(:,:,1);
Edens1=Edens{1}.Edensin;

edenscoef=eust*dt/h./Edens{1}.Edensin(2:Emm,2:En,2:Ep);
