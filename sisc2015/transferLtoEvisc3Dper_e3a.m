function viscmat=transferLtoEvisc3Dper_e3a(h,x,y,z,X,visc,addlvisc,numOfnonzero,lev,zlength,xlength,r)
...
for c1=1:numOfnonzero
    ...
    if ximin==0 
        ...
        viscmat(yimin+1:yimax+1,ximin+1:En-1,zimin+1:zimax+1)=tempval+viscmat(yimin+1:yimax+1,ximin+1:En-1,zimin+1:zimax+1);
        ...
        if zimin==0
            ...
            tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
            viscmat(yimin+1:yimax+1,ximin+1:En-1,zimin+1:Ep-1)=tempval+viscmat(yimin+1:yimax+1,ximin+1:En-1,zimin+1:Ep-1);
            ...
            zdist=abs(zlocal-X(c1,3)-zlength)/rc;
             ...
             tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
             viscmat(yimin+1:yimax+1,1:ximax+1,zimin+1:Ep-1)=tempval+viscmat(yimin+1:yimax+1,1:ximax+1,zimin+1:Ep-1);
        elseif zimax==Ep-2
            ...
            tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
            viscmat(yimin+1:yimax+1,ximin+1:En-1,1:zimax+1)=tempval+viscmat(yimin+1:yimax+1,ximin+1:En-1,1:zimax+1);
            ...
            zdist=abs(zlocal-X(c1,3)+zlength)/rc;
             ...
             tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
             viscmat(yimin+1:yimax+1,1:ximax+1,1:zimax+1)=tempval+viscmat(yimin+1:yimax+1,1:ximax+1,1:zimax+1);
        end
    elseif ximax==En-2
        ...
        tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        viscmat(yimin+1:yimax+1,1:1:ximax+1,zimin+1:zimax+1)=tempval+viscmat(yimin+1:yimax+1,1:ximax+1,zimin+1:zimax+1);
    ...
    elseif zimin==0
        ...
        tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        viscmat(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:Ep-1)=tempval+viscmat(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:Ep-1);
    ...
    elseif zimax==Ep-2
       ...
       xlocal=h*xlocal;
        ...
        tempval=coefvisc*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        viscmat(yimin+1:yimax+1,ximin+1:ximax+1,1:zimax+1)=tempval+viscmat(yimin+1:yimax+1,ximin+1:ximax+1,1:zimax+1);
    end  
