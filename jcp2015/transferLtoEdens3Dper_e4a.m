...
for c1=1:numOfnonzero
    ...
    Edens(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:zimax+1));
    ...
    if ximin==0 
        ...
        tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        Edens(yimin+1:yimax+1,ximin+1:En-1,zimin+1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:En-1,zimin+1:zimax+1));
        ...
        if zimin==0
            ...
            tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
            Edens(yimin+1:yimax+1,ximin+1:En-1,zimin+1:Ep-1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:En-1,zimin+1:Ep-1));
            ...
            zdist=abs(zlocal-X(c1,3)-zlength)/rc;
             ...
             tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
             Edens(yimin+1:yimax+1,1:ximax+1,zimin+1:Ep-1)=max(tempval,Edens(yimin+1:yimax+1,1:ximax+1,zimin+1:Ep-1));
        elseif zimax==Ep-2
            ...
            tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
            Edens(yimin+1:yimax+1,ximin+1:En-1,1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:En-1,1:zimax+1));
            ...
            zdist=abs(zlocal-X(c1,3)+zlength)/rc;
             ...
             tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
             Edens(yimin+1:yimax+1,1:ximax+1,1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,1:ximax+1,1:zimax+1));
        end
    elseif ximax==En-2
        ...
        tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        Edens(yimin+1:yimax+1,1:1:ximax+1,zimin+1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,1:ximax+1,zimin+1:zimax+1));
    ...
    elseif zimin==0
        ...
        tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        Edens(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:Ep-1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:ximax+1,zimin+1:Ep-1));
    ...
    elseif zimax==Ep-2
       ...
       xlocal=h*xlocal;
        ...
        tempval=coef*(dirac_interp_new(xdist).*dirac_interp_new(ydist).*dirac_interp_new(zdist));
        Edens(yimin+1:yimax+1,ximin+1:ximax+1,1:zimax+1)=max(tempval,Edens(yimin+1:yimax+1,ximin+1:ximax+1,1:zimax+1));
    end  
