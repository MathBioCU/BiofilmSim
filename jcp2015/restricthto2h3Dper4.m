function r2h=restricthto2h3Dper4(rh)
...
r2h(1,2:pn-1,2:pp-1)=(rh(2,2:2:Enmmm,4:2:Epm)+rh(2,4:2:Enm,4:2:Epm)+...
    rh(2,2:2:Enmmm,2:2:Epmmm)+rh(2,4:2:Enm,2:2:Epmmm))/64+...
    (rh(2,2:2:Enmmm,3:2:Epmm)+rh(2,4:2:Enm,3:2:Epmm)+rh(2,3:2:Enmm,4:2:Epm)+rh(2,3:2:Enmm,2:2:Epmmm)...
    +rh(1,4:2:Enm,4:2:Epm)+rh(1,2:2:Enmmm,4:2:Epm)+...
    +rh(1,4:2:Enm,2:2:Epmmm)+rh(1,2:2:Enmmm,2:2:Epmmm))/32+...
    (rh(2,3:2:Enmm,3:2:Epmm)+...
...
r2h(pm,2:pn-1,2:pp-1)=(rh(Emm,2:2:Enmmm,4:2:Epm)+rh(Emm,4:2:Enm,4:2:Epm)+...
    rh(Emm,2:2:Enmmm,2:2:Epmmm)+rh(Emm,4:2:Enm,2:2:Epmmm))/64+...
    (rh(Emm,2:2:Enmmm,3:2:Epmm)+rh(Emm,4:2:Enm,3:2:Epmm)+rh(Emm,3:2:Enmm,4:2:Epm)+rh(Emm,3:2:Enmm,2:2:Epmmm)...
    +rh(Em,4:2:Enm,4:2:Epm)+rh(Em,2:2:Enmmm,4:2:Epm)+...
    +rh(Em,4:2:Enm,2:2:Epmmm)+rh(Em,2:2:Enmmm,2:2:Epmmm))/32+...
    (rh(Emm,3:2:Enmm,3:2:Epmm)+...
...
r2h(1,2:pn-1,1)=(rh(2,2:2:Enmmm,2)+rh(2,4:2:Enm,2)+...
    rh(2,2:2:Enmmm,Epm)+rh(2,4:2:Enm,Epm))/64+...
    (rh(2,2:2:Enmmm,1)+rh(2,4:2:Enm,1)+rh(2,3:2:Enmm,2)+rh(2,3:2:Enmm,Epm)...
...
r2h(pm,2:pn-1,1)=(rh(Emm,2:2:Enmmm,2)+rh(Emm,4:2:Enm,2)+...
    rh(Emm,2:2:Enmmm,Epm)+rh(Emm,4:2:Enm,Epm))/64+...
    (rh(Emm,2:2:Enmmm,1)+rh(Emm,4:2:Enm,1)+rh(Emm,3:2:Enmm,2)+rh(Emm,3:2:Enmm,Epm)...
...
r2h(1,1,2:pp-1)=(rh(2,Enm,4:2:Epm)+...
    rh(2,2,4:2:Epm)+...
    rh(2,Enm,2:2:Epmmm)+...
    rh(2,2,2:2:Epmmm))/64+...
    (rh(2,2,3:2:Epmm)+...
    ...
    rh(2,1,2:2:Epmmm)+rh(1,2,2:2:Epmmm)+...
...
r2h(pm,1,2:pp-1)=(rh(Emm,Enm,4:2:Epm)+...
    rh(Emm,2,4:2:Epm)+...
    rh(Emm,Enm,2:2:Epmmm)+...
    rh(Emm,2,2:2:Epmmm))/64+...
    (rh(Emm,2,3:2:Epmm)+...
    rh(Emm,Enm,3:2:Epmm)+rh(Emm,2,3:2:Epmm)+...
    rh(Em,2,4:2:Epm)+2*rh(Emm,1,4:2:Epm)+rh(Em,Enm,4:2:Epm)+...
    rh(Emm,1,2:2:Epmmm)+rh(Em,2,2:2:Epmmm)+...
