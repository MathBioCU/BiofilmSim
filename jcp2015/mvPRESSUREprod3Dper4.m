...
ph=relaxPRESSUREprodRB3Dper2_mex(ph,fh,numrel1,pcoef{lev});
if lev==levels%30
     ph=ph-mean(mean(mean(ph(:,1:end-1,1:end-1))));
     phnew=relaxPRESSUREprodRB3Dper2_mex(ph,fh,10,pcoef{lev});
else
    ...
    phnew=relaxPRESSUREprodRB3Dper2_mex(phnew,fh,numrel2,pcoef{lev});
