...
% %     phnew(2:Emm,2:Enm,2:Epm)=rhsfixed(:,1:Enmm,1:Epmm)+pcoef.coefpp1(:,1:Enmm,1:Epmm).*phnew(2:Emm,3:En,2:Epm)+...
% %         pcoef.coefpm1(:,1:Enmm,1:Epmm).*phnew(2:Emm,1:Enmm,2:Epm)+pcoef.coefpp2(:,1:Enmm,1:Epmm).*phnew(3:Em,2:Enm,2:Epm)+...
% %         pcoef.coefpm2(:,1:Enmm,1:Epmm).*phnew(1:Emmm,2:Enm,2:Epm)+pcoef.coefpp3(:,1:Enmm,1:Epmm).*phnew(2:Emm,2:Enm,3:Ep)+...
% %         pcoef.coefpm3(:,1:Enmm,1:Epmm).*phnew(2:Emm,2:Enm,1:Epmm);
% %     
% %     phnew(1,2:Enm,2:Epm)=rhsfixedboundB(1,1:Enmm,1:Epmm)+pcoef.coefpp1boundB(:,1:Enmm,1:Epmm).*phnew(1,3:En,2:Epm)+...
% %         pcoef.coefpm1boundB(:,1:Enmm,1:Epmm).*phnew(1,1:Enmm,2:Epm)+pcoef.coefpp2boundB(:,1:Enmm,1:Epmm).*phnew(2,2:Enm,2:Epm)+...
% %         pcoef.coefpp3boundB(:,1:Enmm,1:Epmm).*phnew(1,2:Enm,3:Ep)+...
% %         pcoef.coefpm3boundB(:,1:Enmm,1:Epmm).*phnew(1,2:Enm,1:Epmm); %bottom interior
% %     
% %     phnew(Em,2:Enm,2:Epm)=rhsfixedboundT(1,1:Enmm,1:Epmm)+pcoef.coefpp1boundB(:,1:Enmm,1:Epmm).*phnew(Em,3:En,2:Epm)+...
% %         pcoef.coefpm1boundT(:,1:Enmm,1:Epmm).*phnew(Em,1:Enmm,2:Epm)+pcoef.coefpm2boundT(:,1:Enmm,1:Epmm).*phnew(Emm,2:Enm,2:Epm)+...
% %         pcoef.coefpp3boundT(:,1:Enmm,1:Epmm).*phnew(Em,2:Enm,3:Ep)+...
% %         pcoef.coefpm3boundT(:,1:Enmm,1:Epmm).*phnew(Em,2:Enm,1:Epmm); %top of interior
% %     
% %     phnew(2:Emm,2:Enm,Ep)=rhsfixed(:,1:Enmm,Epm)+pcoef.coefpp1(:,1:Enmm,Epm).*phnew(2:Emm,3:En,Ep)+...
% %         pcoef.coefpm1(:,1:Enmm,Epm).*phnew(2:Emm,1:Enmm,Ep)+pcoef.coefpp2(:,1:Enmm,Epm).*phnew(3:Em,2:Enm,Ep)+...
% %         pcoef.coefpm2(:,1:Enmm,Epm).*phnew(1:Emmm,2:Enm,Ep)+pcoef.coefpp3(:,1:Enmm,Epm).*phnew(2:Emm,2:Enm,2)+...
% %         pcoef.coefpm3(:,1:Enmm,Epm).*phnew(2:Emm,2:Enm,Epm);
% %     phnew(2:Emm,2:Enm,1)=phnew(2:Emm,2:Enm,Ep); %right side of interior
% %     
% %     
% %      phnew(1,2:Enm,Ep)=rhsfixedboundB(1,1:Enmm,Epm)+pcoef.coefpp1boundB(:,1:Enmm,Epm).*phnew(1,3:En,Ep)+...
% %         pcoef.coefpm1boundB(:,1:Enmm,Epm).*phnew(1,1:Enmm,Ep)+pcoef.coefpp2boundB(:,1:Enmm,Epm).*phnew(2,2:Enm,Ep)+...
% %         pcoef.coefpp3boundB(:,1:Enmm,Epm).*phnew(1,2:Enm,2)+...
% %         pcoef.coefpm3boundB(:,1:Enmm,Epm).*phnew(1,2:Enm,Epm); %bottom right
% %     phnew(1,2:Enm,1)=phnew(1,2:Enm,Ep);
% %     
% %     phnew(Em,2:Enm,Ep)=rhsfixedboundT(1,1:Enmm,Epm)+pcoef.coefpp1boundB(:,1:Enmm,Epm).*phnew(Em,3:En,Ep)+...
% %         pcoef.coefpm1boundT(:,1:Enmm,Epm).*phnew(Em,1:Enmm,Ep)+pcoef.coefpm2boundT(:,1:Enmm,Epm).*phnew(Emm,2:Enm,Ep)+...
% %         pcoef.coefpp3boundT(:,1:Enmm,Epm).*phnew(Em,2:Enm,2)+...
% %         pcoef.coefpm3boundT(:,1:Enmm,Epm).*phnew(Em,2:Enm,Epm); %top right
% %     phnew(Em,2:Enm,1)=phnew(Em,2:Enm,Ep);
% % %     
% %     
% %     
% %      phnew(2:Emm,En,2:Epm)=rhsfixed(:,Enm,1:Epmm)+pcoef.coefpp1(:,Enm,1:Epmm).*phnew(2:Emm,2,2:Epm)+...
% %         pcoef.coefpm1(:,Enm,1:Epmm).*phnew(2:Emm,Enm,2:Epm)+pcoef.coefpp2(:,Enm,1:Epmm).*phnew(3:Em,En,2:Epm)+...
% %         pcoef.coefpm2(:,Enm,1:Epmm).*phnew(1:Emmm,En,2:Epm)+pcoef.coefpp3(:,Enm,1:Epmm).*phnew(2:Emm,En,3:Ep)+...
% %         pcoef.coefpm3(:,Enm,1:Epmm).*phnew(2:Emm,En,1:Epmm);
% %     phnew(2:Emm,1,2:Epm)=phnew(2:Emm,En,2:Epm); %front of interior
% %     
% %     phnew(2:Emm,En,Ep)=rhsfixed(:,Enm,Epm)+pcoef.coefpp1(:,Enm,Epm).*phnew(2:Emm,2,Ep)+...
% %         pcoef.coefpm1(:,Enm,Epm).*phnew(2:Emm,Enm,Ep)+pcoef.coefpp2(:,Enm,Epm).*phnew(3:Em,En,Ep)+...
% %         pcoef.coefpm2(:,Enm,Epm).*phnew(1:Emmm,En,Ep)+pcoef.coefpp3(:,Enm,Epm).*phnew(2:Emm,En,2)+...
% %         pcoef.coefpm3(:,Enm,Epm).*phnew(2:Emm,En,Epm);
% %     phnew(2:Emm,1,Ep)=phnew(2:Emm,En,Ep); %front right of interior
% %     phnew(2:Emm,1,1)=phnew(2:Emm,En,Ep);
% %     phnew(2:Emm,En,1)=phnew(2:Emm,En,Ep);
% %     
% %     phnew(1,En,2:Epm)=rhsfixedboundB(1,Enm,1:Epmm)+pcoef.coefpp1boundB(:,Enm,1:Epmm).*phnew(1,2,2:Epm)+...
% %         pcoef.coefpm1boundB(:,Enm,1:Epmm).*phnew(1,Enm,2:Epm)+pcoef.coefpp2boundB(:,Enm,1:Epmm).*phnew(2,En,2:Epm)+...
% %         pcoef.coefpp3boundB(:,Enm,1:Epmm).*phnew(1,En,3:Ep)+...
% %         pcoef.coefpm3boundB(:,Enm,1:Epmm).*phnew(1,En,1:Epmm); %bottom front
% %     phnew(1,1,2:Epm)=phnew(1,En,2:Epm);
% %     
% %     phnew(Em,En,2:Epm)=rhsfixedboundT(1,Enm,1:Epmm)+pcoef.coefpp1boundB(:,Enm,1:Epmm).*phnew(Em,2,2:Epm)+...
% %         pcoef.coefpm1boundT(:,Enm,1:Epmm).*phnew(Em,Enm,2:Epm)+pcoef.coefpm2boundT(:,Enm,1:Epmm).*phnew(Emm,En,2:Epm)+...
% %         pcoef.coefpp3boundT(:,Enm,1:Epmm).*phnew(Em,En,3:Ep)+...
% %         pcoef.coefpm3boundT(:,Enm,1:Epmm).*phnew(Em,En,1:Epmm); %top of front
% %     phnew(Em,1,2:Epm)=phnew(Em,En,2:Epm);
% %     
% %     phnew(1,En,Ep)=rhsfixedboundB(1,Enm,Epm)+pcoef.coefpp1boundB(:,Enm,Epm).*phnew(1,2,Ep)+...
% %         pcoef.coefpm1boundB(:,Enm,Epm).*phnew(1,Enm,Ep)+pcoef.coefpp2boundB(:,Enm,Epm).*phnew(2,En,Ep)+...
% %         pcoef.coefpp3boundB(:,Enm,Epm).*phnew(1,En,2)+...
% %         pcoef.coefpm3boundB(:,Enm,Epm).*phnew(1,En,Epm); %bottom front corners
% %     phnew(1,1,Ep)=phnew(1,En,Ep);
% %     phnew(1,1,1)=phnew(1,En,Ep);
% %     phnew(1,En,1)=phnew(1,En,Ep);
% %     
% %      phnew(Em,En,Ep)=rhsfixedboundT(1,Enm,Epm)+pcoef.coefpp1boundB(:,Enm,Epm).*phnew(Em,2,Ep)+...
% %         pcoef.coefpm1boundT(:,Enm,Epm).*phnew(Em,Enm,Ep)+pcoef.coefpm2boundT(:,Enm,Epm).*phnew(Emm,En,Ep)+...
% %         pcoef.coefpp3boundT(:,Enm,Epm).*phnew(Em,En,2)+...
% %         pcoef.coefpm3boundT(:,Enm,Epm).*phnew(Em,En,Epm); %top of front corners
